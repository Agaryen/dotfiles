...
-- beautiful init
beautiful.init(os.getenv("HOME") .. "/.config/awesome/themes/matrix/theme.lua")
...
tags = {
   ...
   layout = { layouts[2], layouts[2], layouts[2], layouts[2], layouts[2], layouts[2], layouts[2], layouts[2], layouts[2], layouts[2], layouts[2], layouts[2], layouts[2], layouts[2], layouts[9]}
}
...
netwidget = wibox.widget.background(lain.widgets.net({
    settings = function()
        widget:set_markup(markup("#f20a0a", " ↓ " .. net_now.received
                          .. " KB ") ..
                          markup("#00D500", " ↑ " .. net_now.sent .. " KB "))
    end
}), "#313131")
